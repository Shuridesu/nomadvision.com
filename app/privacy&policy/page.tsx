  ...
  return (
    <div>
      <div className="w-full sm:w-4/5 mx-auto bg-gray-100 bg-opacity-80 px-10 py-6 mt-6">
        <h1 className="font-bold text-4xl mt-20 text-center">PRIVACY POLICY</h1>
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          This Privacy Policy document outlines the types of personal
          information that is received and collected by NomadVision.net and how
          it is used.
        </p>
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          ...
          identification information from Users in various ways, including, but
          not limited to, when Users visit our site, register, fill out a form,
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          ...
          site. This may include the browser name, type of computer, and
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          nomadvision.net may collect and use Users&apos; personal information
          for the following purposes:
        </p>
        <ul className="mt-10 w-10/12 lg:w-1/3 mx-auto text-left text-sm sm:text-xl lg:text-2xl">
          <li>To improve customer service</li>
          <li className="mt-2">To personalize user experience</li>
          <li className="mt-2">To improve our Site</li>
          <li className="mt-2">To send periodic emails</li>
        </ul>
        <h1 className="font-semibold text-3xl text-center mt-16">
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          ...
          Users&apos; web browsers place cookies on their hard drives for
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          nomadvision.net has the discretion to update this privacy policy at
        ...
        <p className="mt-16 text-sm sm:text-xl lg:text-2xl">
          ...
          this site, or your dealings with this site, please feel free to
          contact us.
        </p>
        <p className="mt-24 text-sm sm:text-xl lg:text-2xl text-gray-400 w-2/3 mx-auto">
          This document was last updated on [2023 19/Dec].
        </p>
      </div>
